...
/* harmony import */ var _jquery_slim_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jquery.slim.min */ "./resources/js/jquery.slim.min.js");
/* harmony import */ var _jquery_slim_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_jquery_slim_min__WEBPACK_IMPORTED_MODULE_1__);
...
_jquery_slim_min__WEBPACK_IMPORTED_MODULE_1___default()(window).scroll(function () {
  var scroll = _jquery_slim_min__WEBPACK_IMPORTED_MODULE_1___default()(window).scrollTop();

  if (scroll >= 50) {
    _jquery_slim_min__WEBPACK_IMPORTED_MODULE_1___default()('.sticky-header').addClass('sticky-header-active');
  } else {
    _jquery_slim_min__WEBPACK_IMPORTED_MODULE_1___default()('.sticky-header').removeClass('sticky-header-active');
  }
});
